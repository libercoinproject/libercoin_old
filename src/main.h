...
static const unsigned int MAX_STANDARD_TX_SIZE = 524288; 
//! -maxtxfee default
...
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 16777216; // 16 MB
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64_t DUST_HARD_LIMIT = 10;   // 10 milli-Libereum
...
#define ZC_CHECK_BUG_FIXED_AT_BLOCK	17857
...
#define OLD_LIMIT_SPEND_TXS 0

// Add more spend txs per block at block height
#define SWITCH_TO_MORE_SPEND_TXS 1
...
static const uint64_t MIN_DISK_SPACE_FOR_BLOCK_FILES = 512 * 1024 * 1024;
...
//BTZC: ADD params for libercoin works
