...
//    const char* pszTimestamp = "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks";
    //btzc: libercoin timestamp
    const char *pszTimestamp = "Decentralization. Privacy. Money. Libercoin.";
...
//        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000003418b3ccbe5e93bcb39b43");
        ...
        // libernode params
        consensus.nLibernodePaymentsStartBlock = HF_LIBERNODE_PAYMENT_START; // not true, but it's ok as long as it's less then nZnodePaymentsIncreaseBlock
        //consensus.nLibernodePaymentsIncreaseBlock = 260000; // actual historical value
        //consensus.nLibernodePaymentsIncreasePeriod = 576*30; // 17280 - actual historical value
        ...
        strLibernodePaymentsPubKey = "04549ac134f694c0243f503e8c8a9a986f5de6610049c40b07816809b0d1d06a21b07be27b9bb555931773f62ba6cf35a25fd52f694d4e1106ccd237a7bb899fdd";
           ...
           `  * a large 32-bit integer with any alignment.
             */
        //btzc: update libercoin pchMessage
        ...
        //std::cout << "libercoin new genesis hash: " << genesis.GetHash().ToString() << std::endl;
        //std::cout << "libercoin new hashMerkleRoot hash: " << genesis.hashMerkleRoot.ToString() << std::endl;
        consensus.hashGenesisBlock = genesis.GetHash();
        //btzc: update main libercoin hashGenesisBlock and hashMerkleRoot
...
public:
    CTestNetParams() {
        ...
        // libernode params testnet
        consensus.nLibernodePaymentsStartBlock = HF_LIBERNODE_PAYMENT_START; // not true, but it's ok as long as it's less then nLibernodePaymentsIncreaseBlock
        //consensus.nLibernodePaymentsIncreaseBlock = 46000; // actual historical value
        //consensus.nLibernodePaymentsIncreasePeriod = 576; // 17280 - actual historical value
        ...
        strLibernodePaymentsPubKey = "046f78dcf911fbd61910136f7f0f8d90578f68d0b3ac973b5040fb7afb501b5939f39b108b0569dca71488f5bbf498d92e4d1194f6f941307ffd95f75e76869f0e";
        ...
        std::cout << "libercoin test new genesis hash: " << genesis.GetHash().ToString() << std::endl;
        std::cout << "libercoin test new hashMerkleRoot hash: " << genesis.hashMerkleRoot.ToString() << std::endl;
        consensus.hashGenesisBlock = genesis.GetHash();

        //btzc: update testnet libercoin hashGenesisBlock and hashMerkleRoot
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1478117690, 177, 536936447, 2, 0 * COIN, extraNonce);
        consensus.hashGenesisBlock = genesis.GetHash();
        //btzc: update regtest libercoin hashGenesisBlock and hashMerkleRoot
//        std::cout << "libercoin regtest genesisBlock hash: " << consensus.hashGenesisBlock.ToString() << std::endl;
//        std::cout << "libercoin regtest hashMerkleRoot hash: " << genesis.hashMerkleRoot.ToString() << std::endl;
        //btzc: update testnet libercoin hashGenesisBlock and hashMerkleRoot
        assert(consensus.hashGenesisBlock ==
               uint256S("0x6283b7fafca969a803f6f539f5e8fb1a4f8a28fc1ec2106ad35b39354a4647e5"));
        assert(genesis.hashMerkleRoot ==
