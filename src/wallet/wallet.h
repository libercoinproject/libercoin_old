...
enum AvailableCoinsType
{
    ...
    ONLY_1000 = 5, // find libernode outputs including locked ones (use with caution)
...
public:
    ...
    // libernode
    /// Get 1000 ZOI output and keys which can be used for the Libernode
    bool GetLibernodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
