...
int64_t CTransaction::nMinTxFee = 1000; // 1 libereum
/** Fees smaller than this (in ztoshi) are considered zero fee (for relaying) */
int64_t CTransaction::nMinRelayTxFee = 1000; // 1 libereum

/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 16777216; // 16 MB
/** Dust Soft Limit, allowed with additional fee per output */
static const int64_t DUST_SOFT_LIMIT = 1000; // 1 libereum
/** The maximum allowed size for a serialized block, in bytes (network rule) */
static const unsigned int MAX_BLOCK_SIZE = 67108864;                      // 64 MB block hard limit
/** Obsolete: maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/2;         // 32 MB  block soft limit
