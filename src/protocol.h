...
extern const char *BLOCKTXN;
    ...
    extern const char *LIBERNODEPAYMENTVOTE;
    extern const char *LIBERNODEPAYMENTSYNC;
...
enum GetDataMsg
{
    ...
    MSG_SPORK,
    MSG_LIBERNODE_PAYMENT_VOTE,
    MSG_LIBERNODE_PAYMENT_BLOCK,
    MSG_LIBERNODE_ANNOUNCE,
    MSG_LIBERNODE_PING,
    MSG_LIBERNODE_VERIFY,
    MSG_TXLOCK_REQUEST,
    MSG_TXLOCK_VOTE,
    MSG_DSTX,
    DSQUEUE,
