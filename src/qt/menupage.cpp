// Copyright (c) 2018 The Libercoin Developers
  ...
  walletModel(0)
{
   ...
   connect(ui->Libernode, SIGNAL(pressed()), this, SLOT(ClickedItem()));
...
void MenuPage::ClickedItem(){
    ...
    ui->Libernode->setCheckable(false);
    ...
    ui->Libernode ->setStyleSheet("color: rgb(0, 0, 0);height: 60px;padding-left: 5px; text-align:left;");
    ...
    case 7:
        ...
        break;
    case 8:
        ui->Libernode->setCheckable(true);
        ui->Libernode->setStyleSheet("color: rgb(75, 13, 149); border-left :5px solid rgb(74,14,149);height: 60px;padding-left: 5px; text-align:left;");
        break;
    case 9:
...
void MenuPage::LinkMenu(BitcoinGUI *gui){
    ...
    connect(ui->Libernode, SIGNAL(pressed()), gui, SLOT(gotoLibernodePage()));
...
void MenuPage::SimulateLibernodeClick(){
