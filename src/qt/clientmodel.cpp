...
QString ClientModel::getlibernodeCountString() const
{
...
{
    QString newlibernodeCountString = getlibernodeCountString();

    if (cachedlibernodeCountString != newlibernodeCountString)
    {
        cachedlibernodeCountString = newlibernodeCountString;

        Q_EMIT strlibernodesChanged(cachedlibernodeCountString);
    }
}
