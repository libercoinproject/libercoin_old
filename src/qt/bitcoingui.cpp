...
void BitcoinGUI::gotoLibernodePage()
{
     QSettings settings;
     if (walletFrame) walletFrame->gotoLibernodePage();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Libercoin network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    if(!libernodeSync.IsBlockchainSynced())
    {
...
void BitcoinGUI::setAdditionalDataSyncProgress(int count, double nSyncProgress)
{
    ...
    if(libernodeSync.IsBlockchainSynced())
    {
        ...
        strSyncStatus = QString(libernodeSync.GetSyncStatus().c_str());
