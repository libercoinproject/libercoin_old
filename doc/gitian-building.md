...
*Setup instructions for a Gitian build of Libercoin Core using a Debian VM or physical system.*
...
- [Building Libercoin Core](#building-bitcoin-core)
...
in the libercoin repository under 'Fetch and create inputs' to install sources which require
...
To build Libercoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
For example:
```bash
URL=https://github.com/snguyen-vn/libercoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit libercoin=${COMMIT} --url bitcoin=${URL} ../bitcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit libercoin=${COMMIT} --url bitcoin=${URL} ../bitcoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit libercoin=${COMMIT} --url bitcoin=${URL} ../bitcoin/contrib/gitian-descriptors/gitian-osx.yml
```
